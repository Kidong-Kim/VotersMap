...
When /^(?:|I )click profile for "([^"]*)"$/ do |name|
  visit show_representatives_path(Representative.find_by(name: name))
end
...
When /^(?:|I )click on the county "([^"]*)"$/ do |county|
  visit search_representatives_path(county)
end

Given /all data$/ do 

  require File.expand_path('db/seed_data')
