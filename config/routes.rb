...
Rails.application.routes.draw do
    ...
    get '/representatives/:representative_id/profile' => 'representatives#show', :as => 'show_representatives'
    get '/representatives/my_news_item/new/' => 'my_news_items#search', :as => 'search_news'
    get '/representatives/my_news_item/new/search' => 'my_news_items#search_issue', :as => 'search_news_issue'
    get '/representatives/my_news_item/new/search/:representative_id/:issue/rating' => 'my_news_items#rate_articles', :as => 'rate_articles'
    get '/representatives/my_news_item/new/search/(:representative_id)/(:issue)' => 'my_news_items#search_issue_rep', :as => 'search_news_issue_rep'
end
